...
#define cpu_readport wsReadPort
#define cpu_writeport wsWritePort
#define cpu_writemem20 wsWriteMem
...
#define GetMemB(Seg,Off) ((UINT8)ROM[(DefaultBase(Seg)+(Off))>>16][(UINT16)(DefaultBase(Seg)+(Off))])
#define GetMemW(Seg,Off) ((UINT16)ROM[(DefaultBase(Seg)+(Off))>>16][(UINT16)(DefaultBase(Seg)+(Off))]+(ROM[(DefaultBase(Seg)+(Off)+1)>>16][(UINT16)(DefaultBase(Seg)+(Off)+1)]<<8))
...
#define ReadByte(ea) ((BYTE)ROM[(ea)>>16][(UINT16)(ea)])
#define ReadWord(ea) ( ROM[(ea)>>16][(UINT16)(ea)]+(ROM[((ea)+1)>>16][(UINT16)((ea)+1)]<<8))
...
#define FETCH (ROM[((I.sregs[CS]<<4)+I.ip)>>16][(UINT16)((I.sregs[CS]<<4)+I.ip++)])
#define FETCHOP (ROM[((I.sregs[CS]<<4)+I.ip)>>16][(UINT16)((I.sregs[CS]<<4)+I.ip++)])
#define FETCHWORD(var) { var=ROM[((I.sregs[CS]<<4)+I.ip)>>16][(UINT16)((I.sregs[CS]<<4)+I.ip)]+(ROM[((I.sregs[CS]<<4)+I.ip+1)>>16][(UINT16)((I.sregs[CS]<<4)+I.ip+1)]<<8); I.ip+=2; }
...
#define PEEK(addr) ((BYTE)ROM[(addr)>>16][(UINT16)(addr)])
#define PEEKOP(addr) ((BYTE)ROM[(addr)>>16][(UINT16)(addr)])

#define GetModRM UINT32 ModRM=ROM[((I.sregs[CS]<<4)+I.ip)>>16][(UINT16)((I.sregs[CS]<<4)+I.ip++)]
