...
{\
	...
	strcpy(szDebugMsg, msg);\
	strcat(szDebugMsg, "\n");\
	OutputDebugString(szDebugMsg, strlen(szDebugMsg));\
}
...
{\
	...
	strcpy(szDebugMsg, msg);\
	strcat(szDebugMsg, " = ");\
	sprintf(szTemp, "%X", val1); \
	strcat(szDebugMsg, szTemp);\
	strcat(szDebugMsg, " , ");\
	sprintf(szTemp, "%X", val2); \
	strcat(szDebugMsg, szTemp);\
	strcat(szDebugMsg, "\n");\
	OutputDebugString(szDebugMsg, strlen(szDebugMsg));\
}
